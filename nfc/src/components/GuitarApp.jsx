...
const AddGuitar = ({server, tag_id, guitarExists }) => {
  const [imageUrl, setImageUrl] = useState(null);
  const [showModal, setShowModal] = useState(false);
  const fileInputRef = useRef(null);
  const [selectedFile, setSelectedFile] = useState(null);
  const [guitarImage, setGuitarImage] = useState(false);
  ...
  return (
    ...
    <img
      ...
      <Modal centered show={showModal} onHide={handleCloseModal}>
        ...
        <Modal.Footer>
          <Button variant="primary" block onClick={handleCaptureClick}>
            Capture
          </Button>
          <Button variant="primary" block onClick={handleUploadClick}>
            Upload
          </Button>
          <input
            type="file"
